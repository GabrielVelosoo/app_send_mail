<?php
    ...
    */
    ...
    try {
        ...
        $mail->Username   = 'testephpoo1@gmail.com';                     //SMTP username
        $mail->Password   = 'vdmcskpzwdevtcci';                               //SMTP password
        $mail->SMTPSecure = 'tls';            //Enable implicit TLS encryption
        $mail->Port       = 587;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

        //Recipients
        $mail->setFrom('testephpoo1@gmail.com', 'Teste PHP Remetente');
